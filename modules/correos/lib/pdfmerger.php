 ...
 * They are not modified in any way. PDFMerger has all the limitations of the FPDI package - essentially,
 * it cannot import dynamic content
...
class PDFMerger
{
    ...
    public function merge($outputmode = 'browser', $outputpath = 'newfile.pdf')
    {
        ...
        if (isset($_POST['option_order']) &&
            $_POST['option_order'] == 'generate_label_a4' &&
            isset($_POST['print_position'])
        ) {
            $label = $_POST['print_position'];
        }
     
         
        //$fpdi->AddPage('L', array("280", "200"));
