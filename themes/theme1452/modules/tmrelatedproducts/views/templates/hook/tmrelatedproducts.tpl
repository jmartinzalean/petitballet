                ...
                <div class="product_desc">
                  <a href="{$relatedLink|escape:'html':'UTF-8'}" title="{$related.legend|escape:'html':'UTF-8'}" class="product-image product_image">
                    <img itemprop="image" class="b-lazy" style="width: 100%;"
                         ...
                         data-src="{$link->getImageLink($related.link_rewrite, $related.id_image, 'home_default')|escape:'html':'UTF-8'}" alt="{$related.legend|escape:'html':'UTF-8'}" title="{$related.legend|escape:'html':'UTF-8'}"/>
                  </a>
                </div>
