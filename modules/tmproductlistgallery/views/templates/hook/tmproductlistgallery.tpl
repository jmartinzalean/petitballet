...
{if count($product_images) > 1}
  <div class="tmproductlistgallery {$smarty_settings.st_type|escape:'html':'UTF-8'}{if $smarty_settings.st_type == 'slideshow' && $smarty_settings.st_thumbnails && $smarty_settings.st_thumbnails_position == 'vertical'} vertical-thumbnails{/if}{if $smarty_settings.st_type == 'slideshow' && $smarty_settings.st_pager} slideshow-dots{/if}">
    <div class="tmproductlistgallery-images{if $smarty_settings.st_type == 'rollover'} {$smarty_settings.st_roll_type|escape:'html':'UTF-8'}{/if}">
...
{else}
    <a class="product_img_link" href="{$product.link|escape:'html':'UTF-8'}" title="{$product.name|escape:'html':'UTF-8'}" itemprop="url">
      <img class="replace-2x img-responsive" src="{$link->getImageLink($product.link_rewrite, $product.id_image, 'home_default')|escape:'html':'UTF-8'}" alt="{$product.name|escape:html:'UTF-8'}" title="{$product.name|escape:html:'UTF-8'}" />
    </a>
{/if}
