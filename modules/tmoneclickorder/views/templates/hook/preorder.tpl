...
<form enctype="multipart/form-data" class="preorder-form-box">
  ...
  <fieldset>
    ...
    <div class="submit">
      <button class="button btn btn-success" id="submitPreorder" name="submitPreorder" type="submit" {if isset($product)}data-id-product-attribute="{$product.id_product_attribute}" data-id-product="{$product.id_product}" data-quantity="{$product.quantity}" data-customize-id="{$product.id_customization}"{/if}>
