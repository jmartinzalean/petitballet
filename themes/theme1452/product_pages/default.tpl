  ...
  <div itemscope itemtype="https://schema.org/Product">
    ...
    {if !$content_only}
      {if $product->description || (isset($quantity_discounts) && count($quantity_discounts) > 0) || (isset($features) && $features) || (isset($attachments) && $attachments) || (isset($product) && $product->customizable) || (isset($HOOK_PRODUCT_TAB) && $HOOK_PRODUCT_TAB) || (isset($HOOK_PRODUCT_TAB_CONTENT) && $HOOK_PRODUCT_TAB_CONTENT)}
        <div class="row clearfix product-information">
          <div class="tab-content-default col-xs-12 {if $columns == 1}col-sm-8{/if} {if $columns == 2}col-md-8{/if}">
          ...
          <div class="col-xs-12 {if $columns == 1}col-sm-4{/if} {if $columns == 2}col-md-4{/if} reviews-block"></div>
        </div>
      {/if}
                    ...
                    <li class="item product-box ajax_block_product{if $smarty.foreach.accessories_list.first} first_item{elseif $smarty.foreach.accessories_list.last} last_item{else} item{/if} product_accessories_description">
                      <div class="product_desc">
                        <a href="{$accessoryLink|escape:'html':'UTF-8'}" title="{$accessory.legend|escape:'html':'UTF-8'}" class="product-image product_image">
                          <img class="lazyOwl b-lazy" style="width: 100%;" src="{$img_dir}product-lazy-placeholder.jpg" data-src="{$link->getImageLink($accessory.link_rewrite, $accessory.id_image, 'tm_home_default')|escape:'html':'UTF-8'}" alt="{$accessory.legend|escape:'html':'UTF-8'}" title="{$accessory.legend|escape:'html':'UTF-8'}" width="{$homeSize.width}" height="{$homeSize.height}"/>
                        </a>
                      </div>
