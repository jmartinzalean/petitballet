...
{if isset($slides) && $slides}
    <div id="tm-products-slider" class="{$settings.slider_type|escape:'htmlall':'UTF-8'}">
        <div id="slider_container" style="width: {$settings.fullwidth_slider_width|escape:'htmlall':'UTF-8'}px;">
            <div u="slides" class="main-slides" style="width: {$settings.fullwidth_slider_width|escape:'htmlall':'UTF-8'}px; height: {$settings.fullwidth_slider_height|escape:'htmlall':'UTF-8'}px;">
                {foreach from=$slides item=slide}
                    <div class="slide-inner">
                        <div u="thumb">
                            {if isset($slide.image) && $slide.image}
                                <img src="{$link->getImageLink($slide.info->name, $slide.image.id_image, 'medium_default')|escape:'htmlall':'UTF-8'}" />
                            {/if}
                        ...
                        <div class="sliders-wrap">
                            ...
                            {/if}
                            <div class="slide-info {if $slide.image}col-xs-6{else}col-xs-12{/if}">
                                ...
                                {/if}
                                {if $settings.product_name}<h3><a href="{$slide.info->getLink()|escape:'htmlall':'UTF-8'}">{$slide.info->name|escape:'htmlall':'UTF-8'}</a></h3>{/if}
            ...
            {if $settings.fullwidth_extended_settings && $settings.fullwidth_slider_navigation}
