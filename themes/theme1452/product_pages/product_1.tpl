...
{if $errors|@count == 0}
  ...
  {/if}
  <div itemscope itemtype="https://schema.org/Product" class="clearfix">
    ...
    <div class="primary_block row">
      ...
      {/if}
      <!-- left infos-->
      <div class="pb-left-column {if $content_only}col-xs-6{else}col-xs-12{/if}">
                ...
                {foreach from=$images item=image name=thumbnails}
                  ...
                  <li id="thumbnail_{$image.id_image}"{if $smarty.foreach.thumbnails.last} class="last"{/if}>
                    <a
                            ...
                            {else}
                              href="{$link->getImageLink($product->link_rewrite, $imageIds, 'tm_large_default')|escape:'html':'UTF-8'}"
                              data-fancybox-group="other-views"
                              class="fancybox{if $image.id_image == $cover.id_image} shown{/if}"
                            {/if}
                            title="{$imageTitle}">
                      <img class="img-responsive" id="thumb_{$image.id_image}" src="{$link->getImageLink($product->link_rewrite, $imageIds, 'tm_large_default')|escape:'html':'UTF-8'}" alt="{$imageTitle}" title="{$imageTitle}"{if isset($cartSize)} height="{$cartSize.height}" width="{$cartSize.width}"{/if} itemprop="image" />
                    </a>
                  </li>
                {/foreach}
              {/if}
      ...
      <!-- center infos -->
      <div class="pb-right-column {if $content_only}col-xs-6{else}col-xs-12{/if}">
        <div class="row">
          <div class="{if $columns == 2} col-xs-12 {elseif $columns == 3} col-xs-12{else} col-xs-12 col-lg-5{/if}">
          ...
          <div class="{if $columns == 2}col-xs-12 {elseif $columns == 3}col-xs-12 {elseif $content_only} col-xs-6{else} col-xs-12 col-lg-7{/if}">
            {if !$content_only}
