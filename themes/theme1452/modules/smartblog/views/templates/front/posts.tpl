...
<div itemtype="#" itemscope="" id="sdsblogArticle" class="blog-post">
		<h1 class="title_block_exclusive">{$meta_title}
				<span itemprop="dateCreated">
      {$created|date_format:"%d %B %Y"}
    </span>
		</h1>
						...
						<div id="commentInput">
								...
								<form action="" method="post" id="commentform">
										<table>
												...
												<tr>
														<td>
																<input type="text" tabindex="1" class="inputName form-control grey" value="" placeholder="{l s='Name:'  mod='smartblog'}" name="name">
														</td>
												</tr>
												<tr>
														<td>
																<input type="text" tabindex="2" class="inputMail form-control grey" value="" placeholder="{l s='E-mail:' mod='smartblog'} {l s='(Not Published)'  mod='smartblog'}" name="mail">
														</td>
												</tr>
												<tr>
														<td>
																<textarea tabindex="4" placeholder="{l s='Comment:'  mod='smartblog'}" class="inputContent form-control grey" rows="8" cols="50" name="comment"></textarea>
														</td>
												</tr>
												{if Configuration::get('smartcaptchaoption') == '1'}
														...
														<tr>
																<td>
																		<input type="text" placeholder="{l s='Type Code' mod='smartblog'}" tabindex="" value="" name="smartblogcaptcha" class="smartblogcaptcha form-control grey">
																</td>
														</tr>
												{/if}
												</tbody>
										...
										<div class="text-left">
												<div class="submit">
														<button type="submit" name="addComment" id="submitComment" class="button btn btn-md btn-default icon-right button-medium" value="{l s='Submit' mod='smartblog'}">
																<span>{l s='Submit' mod='smartblog'}</span>
														</button>
												</div>
										</div>
								</form>
