...
class HomeSlidePetit extends ObjectModel
{
	public $title;
	public $description;
	public $url;
	...
	public function add($autodate = true, $null_values = false)
	{
		...
		$res &= Db::getInstance()->execute('
			INSERT INTO `'._DB_PREFIX_.'homesliderpetit` (`id_shop`, `id_homeslider_slides`)
	...
	public function delete()
	{
		...
		$res &= Db::getInstance()->execute('
			DELETE FROM `'._DB_PREFIX_.'homesliderpetit`
	...
	public function reOrderPositions()
	{
		...
		$rows = Db::getInstance(_PS_USE_SQL_SLAVE_)->executeS('
			...
			FROM `'._DB_PREFIX_.'homesliderpetit_slides` hss
			LEFT JOIN `'._DB_PREFIX_.'homesliderpetit` hs ON (hss.`id_homeslider_slides` = hs.`id_homeslider_slides`)
