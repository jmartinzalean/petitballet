...
<div class="panel">
  <h3>{l s='TM Products Slides' mod='tmproductssliderpetit'}</h3>
  <div class="clearfix">
      ...
      <div class="col-lg-4">
        ...
        <ul class="slides-list" id="list_{$smarty.foreach.myloop.iteration|escape:'htmlall':'UTF-8'}">
          {foreach from=$list item=item name=itemloop}
              ...
              <li id="item-{$item.id_product|escape:'htmlall':'UTF-8'}" class="item">
                <form method="post" action="" enctype="multipart/form-data" class="defaultForm form-horizontal clearfix">
                  ...
                  <span class="item_name">
                    ...
                    <small>({l s='product ID' mod='tmproductssliderpetit'}
            ...
            {else}
              <li class="no-slides">
                {l s='There are no slides for this shop' mod='tmproductssliderpetit'}
              </li>
            {/if}
          {/foreach}
        </ul>
...
<form method="post" action="" enctype="multipart/form-data" class="defaultForm form-horizontal clearfix">
  <div class="panel">
    <h3>{l s='TM Products Slider Settings' mod='tmproductssliderpetit'}</h3>
    <div class="form-group">
      <label class="control-label col-lg-3">{l s='Slider Width' mod='tmproductssliderpetit'}</label>
      <div class="col-lg-7">
        <div class="input-group">
          <input name="slider_width" type="text" value="{if $settings.slider_width}{$settings.slider_width|escape:'htmlall':'UTF-8'}{/if}" />
          <span class="input-group-addon">{l s='pixels' mod='tmproductssliderpetit'}</span>
        </div>
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-lg-3">{l s='Slider Type' mod='tmproductssliderpetit'}</label>
      <div class="col-lg-2">
    ...
    <div class="form-group">
      <label class="control-label col-lg-3">{l s='Slider Speed' mod='tmproductssliderpetit'}</label>
      <div class="col-lg-7">
        <div class="input-group">
          <input name="slider_speed" type="text" value="{if $settings.slider_speed}{$settings.slider_speed|escape:'htmlall':'UTF-8'}{/if}" />
          <span class="input-group-addon">{l s='milliseconds ' mod='tmproductssliderpetit'}</span>
        </div>
        <p class="help-block">{l s='The duration of the transition between two slides.' mod='tmproductssliderpetit'}</p>
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-lg-3">{l s='Slider Pause' mod='tmproductssliderpetit'}</label>
      <div class="col-lg-7">
        <div class="input-group">
          <input name="slider_pause" type="text" value="{if $settings.slider_pause}{$settings.slider_pause|escape:'htmlall':'UTF-8'}{/if}" />
          <span class="input-group-addon">{l s='milliseconds ' mod='tmproductssliderpetit'}</span>
        </div>
        <p class="help-block">{l s='The delay between two slides.' mod='tmproductssliderpetit'}</p>
       </div>
    </div>
    <div class="form-group">
      <label class="control-label col-lg-3">{l s='Auto play' mod='tmproductssliderpetit'}</label>
      <div class="col-lg-7">
    ...
    <div class="form-group">
      <label class="control-label col-lg-3">{l s='Pause on hover' mod='tmproductssliderpetit'}</label>
      <div class="col-lg-7">
        <span class="switch prestashop-switch fixed-width-lg">
    ...
    <div class="form-group">
    <label class="control-label col-lg-3">{l s='Pager' mod='tmproductssliderpetit'}</label>
      <div class="col-lg-7">
        <span class="switch prestashop-switch fixed-width-lg">
    ...
    <div class="form-group">
      <label class="control-label col-lg-3">{l s='Controls' mod='tmproductssliderpetit'}</label>
      <div class="col-lg-7">
        <span class="switch prestashop-switch fixed-width-lg">
        ...
        <p class="help-block">{l s='Prev/Next buttons.' mod='tmproductssliderpetit'}</p>
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-lg-3">{l s='Auto Controls' mod='tmproductssliderpetit'}</label>
      <div class="col-lg-7">
        <span class="switch prestashop-switch fixed-width-lg">
        ...
        <p class="help-block">{l s='Play/Pause buttons (only if "Auto Play" is active).' mod='tmproductssliderpetit'}</p>
      </div>
    </div>
    <div class="panel-footer">
      <button id="module_form_submit_btn" class="btn btn-default pull-right" name="submitSlider" value="1" type="submit">
        <i class="process-icon-save"></i>
        {l s='Save' mod='tmproductssliderpetit'}
      </button>
    </div>
</div>
</form>