...
class CategoryProductsSlider extends ObjectModel
{
    public $id_shop;
    public $category;
    public $num;
    ...
    public static $definition = array(
        'table' => 'tmcategoryproductsslider',
        'primary' => 'id_tab',
        'multilang' => true,
        'fields' => array(
    ...
    {
        $sql = 'SELECT *
                FROM ' . _DB_PREFIX_ . 'tmcategoryproductsslider tmcp
                JOIN ' . _DB_PREFIX_ . 'tmcategoryproductsslider_lang tmcpl
    ...
    public function getMaxSortOrder($type)
    {
        $sql = 'SELECT MAX(sort_order)
                AS sort_order
                FROM `'._DB_PREFIX_.'tmcategoryproductsslider`
