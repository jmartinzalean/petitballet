...
<div class="product-container" itemscope itemtype="https://schema.org/Product">
  ...
  <div class="right-block">
    ...
    {/if}
    <a class="product_link btn btn-sm btn-default icon-right" href="{$product.link|escape:'html':'UTF-8'}" title="{$product.name|escape:'html':'UTF-8'}" itemprop="url">
      <span>{l s='Show product' mod='tmlookbook'}</span>
    </a>
  </div>
</div>