                ...
                <ul>
                  ...
                  {if $is_logged}
                    {if !$comment.customer_advice}
                      <li>
                        ...
                        <div class="useful-buttons">
                          <button class="usefulness_btn btn btn-xs btn-secondary" data-is-usefull="1" data-id-product-comment="{$comment.id_product_comment}">
                            <span>{l s='Yes' mod='productcomments'}</span>
                          </button>
                          <button class="usefulness_btn btn btn-xs btn-secondary" data-is-usefull="0" data-id-product-comment="{$comment.id_product_comment}">
                    ...
                    {if !$comment.customer_report}
                      <li>
                      <span class="report_btn link" data-id-product-comment="{$comment.id_product_comment}">
