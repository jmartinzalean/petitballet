...
<script type="text/javascript">
	jQuery(document).ready(function ($) {
		var options = {
			$AutoPlay: {if ($settings.standard_extended_settings && $settings.standard_slider_autoplay)}true{else}false{/if},                //[Optional] Whether to auto play, to enable slideshow, this option must be set to true, default value is false
...
{if isset($slides) && $slides}
	<div id="tm-products-slider" class="{$settings.slider_type|escape:'htmlall':'UTF-8'}">
		<div id="slider_container" style="width: {$settings.standard_slider_width|escape:'htmlall':'UTF-8'}px;">
			<div u="slides" class="main-slides" style="width: {$settings.standard_slider_width|escape:'htmlall':'UTF-8'}px; height: {$settings.standard_slider_height|escape:'htmlall':'UTF-8'}px;">
				{foreach from=$slides item=slide}
					<div class="slide-inner">
						...
						{if isset($slide.image) && $slide.image}
							<div class="slide-image col-xs-7">
						...
						{/if}
						<div class="slide-info {if $slide.image}col-xs-5{else}col-xs-12{/if}">
			...
			{/if}
			{if ($settings.standard_extended_settings && $settings.standard_slider_pagination)}
